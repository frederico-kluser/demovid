...
const lines: string[] = [
  ...
  "  durationMs: number;",
  "  easing: string;",
  "  /** As constantes físicas, para o overlay reconstruir a mola em runtime.",
  "   *  O `linear()` acima é uma amostragem congelada dela: serve para uma",
  "   *  transição que vai do início ao fim, mas não sabe retomar de uma",
  "   *  interrupção. `overlay/src/anim.ts` precisa da mola, não da amostra. */",
  "  stiffness: number;",
  "  damping: number;",
  "  mass: number;",

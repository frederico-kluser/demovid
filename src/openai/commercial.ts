 ...
 */
import { z } from "zod";
import { callStructured, RESPONSES_MODEL, ResponsesError, stripNulls } from "./responses.js";
...
export async function writeCommercial(opts: CommercialOptions): Promise<Commercial> {
  ...
  log(`escrevendo a montagem com ${RESPONSES_MODEL}`);
...
export { ResponsesError as CommercialError };
